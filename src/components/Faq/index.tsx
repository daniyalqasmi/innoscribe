      ...
      <div className="container">
        ...
        <div className="-mx-4 mt-[60px] flex flex-wrap lg:mt-20">
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              question="What is Innoscribe? "
              answer="Innoscribe develops AI-powered solutions like chatbots, voice assistants, and custom software."
            />
            <SingleFaq
              question="How can AI chatbots help my business?"
              answer="Innoscribe's chatbots provide 24/7 customer support, answer FAQs, and automate tasks."
            />
            <SingleFaq
              question="What's the benefit of a custom AI assistant? "
              answer="It streamlines your daily tasks and integrates with your existing workflow."
            />
          </div>
          ...
          <div className="w-full px-4 lg:w-1/2">
            <SingleFaq
              ...
              answer="Yes, our team builds custom mobile apps to meet your specific needs."
            />
            <SingleFaq
              question="Can your software integrate with existing systems?"
              answer="Absolutely, seamless integration is a priority for Innoscribe."
            />
            <SingleFaq
              question="How does Innoscribe ensure data security?"
              answer="We take data security very seriously and follow strict industry standards."
            />
          </div>
        </div>
      </div>
