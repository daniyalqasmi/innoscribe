      ...
      >
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-60 max-w-full pr-4 ">
              <Link
                href="/"
                        ...
                        <li key={index} className="group relative ">
                          {pathUrl !== "/" ? (
                            <Link
                              ...
                              scroll={false}
                              href={menuItem.path}
                              className={`ud-menu-scroll flex py-2 text-base text-dark group-hover:text-[#58c0c2] dark:text-white dark:group-hover:text-[#58c0c2] lg:inline-flex lg:px-0 lg:py-6 ${
                            ...
                            <Link
                              ...
                              className={`ud-menu-scroll flex py-2 text-base lg:inline-flex lg:px-0 lg:py-6 ${
                                sticky
                                  ? "text-dark group-hover:text-[#58c0c2] dark:text-white dark:group-hover:text-[#58c0c2]"
                        ...
                        <li className="submenu-item group relative" key={index}>
                          {pathUrl !== "/" ? (
                            <button
                              ...
                              className={`ud-menu-scroll flex items-center justify-between py-2 text-base text-dark group-hover:text-[#58c0c2] dark:text-white dark:group-hover:text-[#58c0c2] lg:inline-flex lg:px-0 lg:py-6`}
                            >
                              {menuItem.title}
                              ...
                              <Link
                                ...
                                className={`block rounded px-4 py-[10px] text-sm ${
                                  pathUrl === submenuItem.path
                                    ? "text-primary"
                                    : "text-body-color hover:text-[#58c0c2] dark:text-dark-6 dark:hover:text-[#58c0c2]"
                                }`}
                              >
                                {submenuItem.title}
                              </Link>
