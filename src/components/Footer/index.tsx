...
const Footer = () => {
  return (
    ...
    <Fade duration={2000}>
    <footer
      className="wow fadeInUp relative z-10 bg-[#58c0c2] pt-20 lg:pt-[100px]"
      data-wow-delay=".15s"
    >
        ...
        <div className="-mx-4 flex flex-wrap">
          <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
            <div className="mb-10 w-full">
              ...
              Welcome to InnoScribe – Elevating Your Conversations with AI!
              </p>
          ...
          <div className="-mx-4 flex flex-wrap">
            ...
            <div className="w-full px-4 md:w-1/3 lg:w-1/2">
              <div className="my-1 flex justify-center md:justify-end">
                ...
                © 2024 | All rights reserved | Powered by Programmiers
                </p>
              </div>
            </div>
          </div>
